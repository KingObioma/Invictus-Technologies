          ...
          {services.map((service, i) => {
            ...
            return (
              ...
              >
                <Link
                  href={service.href}
                  className="group flex flex-col gap-4 p-6 rounded-2xl bg-white/[0.02] border border-white/6 hover:border-violet-500/30 hover:bg-violet-500/[0.03] transition-all duration-300 h-full cursor-pointer"
                >
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center bg-gradient-to-br ${service.accent} border border-violet-500/20`}>
                    <Icon size={20} className="text-violet-400" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-display font-bold text-white text-base mb-2 group-hover:text-violet-300 transition-colors">
                      {service.title}
                    </h3>
                  ...
                  <div className="flex items-center gap-1 text-violet-500/60 group-hover:text-violet-400 transition-colors text-xs font-mono">
                    Learn more
