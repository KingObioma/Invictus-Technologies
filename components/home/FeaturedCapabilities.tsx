    ...
    <section className="section-pad bg-surface relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-[minmax(200px,auto)]">
          ...
          >
            <Link href="/services#ai" className="group flex flex-col h-full min-h-[280px] p-8 rounded-2xl bg-gradient-to-br from-orange-950/30 via-[#0A0A0A] to-black border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 relative overflow-hidden cursor-pointer">
              {/* Background glow */}
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Custom LLM Integration", "RAG Systems", "Predictive Models", "AI Automation", "Vector DBs"].map(t => (
                    <span key={t} className="px-3 py-1 rounded-full text-xs font-mono border border-orange-500/20 text-orange-400/70 bg-orange-500/5">
                      {t}
                    </span>
                  ))}
                </div>

                <div className="flex items-center gap-2 text-orange-400 font-display font-semibold text-sm group-hover:gap-3 transition-all">
                  Explore AI Services
          ...
          <AnimatedSection delay={0.1}>
            <Link href="/services#mobile" className="group flex flex-col h-full min-h-[200px] p-6 rounded-2xl bg-white/[0.02] border border-white/7 hover:border-orange-500/25 hover:bg-orange-500/[0.02] transition-all duration-300 cursor-pointer">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-orange-500/15 to-orange-700/5 border border-orange-500/20 flex items-center justify-center mb-4">
              ...
              <div className="mt-4 flex items-center gap-1 text-orange-500/50 group-hover:text-orange-400 text-xs font-mono transition-colors">
          ...
          <AnimatedSection delay={0.15}>
            <Link href="/services#enterprise" className="group flex flex-col h-full min-h-[200px] p-6 rounded-2xl bg-white/[0.02] border border-white/7 hover:border-orange-500/25 hover:bg-orange-500/[0.02] transition-all duration-300 cursor-pointer">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-orange-500/15 to-orange-700/5 border border-orange-500/20 flex items-center justify-center mb-4">
          ...
          <AnimatedSection delay={0.2} className="md:col-span-2 lg:col-span-1">
            <Link href="/services#cloud" className="group flex flex-col h-full min-h-[200px] p-6 rounded-2xl bg-white/[0.02] border border-white/7 hover:border-orange-500/25 hover:bg-orange-500/[0.02] transition-all duration-300 cursor-pointer">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-orange-500/15 to-orange-700/5 border border-orange-500/20 flex items-center justify-center mb-4">
